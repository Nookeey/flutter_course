...
mixin ProductsModel on ConnectedProductsModel {
  ...
  Future<bool> addProduct(String title, String description, String image, double price) async {
    ...
    try {
      ...
      .post(
        'https://flutter-products-c.firebaseio.com/products.json',
  ...
  Future<bool> updateProduct(String title, String description, String image, double price) {
    ...
    return http.put(
      'https://flutter-products-c.firebaseio.com/products/${selectedProduct.id}.json',
  ...
  Future<Null> fetchProducts() {
    _isLoading = true;
    notifyListeners();
    return http.get('https://flutter-products-c.firebaseio.com/products.json')
